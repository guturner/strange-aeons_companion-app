...
def __configure_bot(bot):
    ...
    async def on_message(message: nextcord.Message):
        ...
        # Slash command invocations arrive as both an interaction and a message in DMs.
        # Ignore the message form here — the interaction handler processes it instead.
...
def __main():
    ...
    # ── Cogs ───────────────────────────────────────────────────────────────
    faction_cog.setup(bot, recipe_book, guild_ids)
